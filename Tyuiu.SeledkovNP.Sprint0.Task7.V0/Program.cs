...
namespace Tyuiu.SeledkovNP.Sprint0.Task7.V0
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Title = "Спринт #0 | Выполнил: Селедков Н. П. | Смартб-24-1";
            ...
            Console.WriteLine("* Выполнил: Селедков Никита Пав. | Смартб-24-1                            *");
            Console.WriteLine("***************************************************************************");
